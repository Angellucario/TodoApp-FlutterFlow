...
class _LoginWidgetState extends State<LoginWidget>
  ...
  void initState() {
    ...
    _model.singupPassTextController ??= TextEditingController();
    _model.singupPassFocusNode ??= FocusNode();

    _model.signUpConfirmedpassTextController ??= TextEditingController();
    _model.signUpConfirmedpassFocusNode ??= FocusNode();
            ...
            child: Column(
              ...
              children: [
                ClipRRect(
                  ...
                  child: Image.asset(
                    'assets/images/03653927-45B2-4D63-AEEA-06333A2E77C1.PNG',
                    width: 120.0,
                    fit: BoxFit.cover,
                  ),
                ),
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                Container(
                                  width: double.infinity,
                                  child: TextFormField(
                                    controller: _model.singupPassTextController,
                                    focusNode: _model.singupPassFocusNode,
                                    autofocus: false,
                                    enabled: true,
                                    textInputAction: TextInputAction.next,
                                    obscureText: !_model.singupPassVisibility,
                                    decoration: InputDecoration(
                                      isDense: true,
                                      labelStyle: FlutterFlowTheme.of(context)
                                          .labelLarge
                                    ...
                                    enableInteractiveSelection: true,
                                    validator: _model
                                        .singupPassTextControllerValidator
                                        .asValidator(context),
                                  ),
                                ),
                                Container(
                                  ...
                                  child: TextFormField(
                                    controller: _model
                                        .signUpConfirmedpassTextController,
                                    focusNode:
                                        _model.signUpConfirmedpassFocusNode,
                                    autofocus: false,
                                    enabled: true,
                                    textInputAction: TextInputAction.next,
                                    obscureText:
                                        !_model.signUpConfirmedpassVisibility,
                                    decoration: InputDecoration(
                                      isDense: true,
                                      labelStyle: FlutterFlowTheme.of(context)
                                          .labelLarge
                  ...
                  children: [
                    ...
                    if (_model.tabBarCurrentIndex == 0)
                      FFButtonWidget(
                        onPressed: () async {
                          GoRouter.of(context).prepareAuthEvent();
                          if (_model.singupPassTextController.text !=
                              _model.signUpConfirmedpassTextController.text) {
                          ...
                          final user = await authManager.createAccountWithEmail(
                            ...
                            _model.singupPassTextController.text,
                          );
                          if (user == null) {
                            return;
                          }
